    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.borderBox}>
        <KeyboardAwareScrollView
          ...
          <View style={styles.headText}>
            <Text style={styles.headTxt}>{login2.welcome}</Text>

            <Text style={styles.headerStyle}>{login2.subHead}</Text>
            <Text style={styles.headerStyle}>{login2.subHead2}</Text>
