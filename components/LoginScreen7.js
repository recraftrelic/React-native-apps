      ...
      <KeyboardAwareScrollView
        ...
        <View>
          <TouchableOpacity
            ...
            <View>
              <Image source={images.arrow_backward} style={styles.backArrow} />
            </View>
          </TouchableOpacity>
          <View style={styles.headText}>
            <Text style={styles.headerStyle}>{login4.header}</Text>

            <Text style={styles.headtextStyle}>{login4.headername}</Text>
          </View>
          <View style={styles.inputView}>
            <Text style={styles.emailtxt}>{login4.EmailAddress}</Text>
            <View>
              <TextInput
                value={email}
            ...
            <View>
              <Text style={styles.passtxt}>{login4.Password}</Text>
              <TextInput
                value={password}
          ...
          <View style={styles.signInBtnView}>
            <TouchableOpacity style={styles.signInBtn} onPress={onLogin}>
              <Text style={styles.signInText}>{login4.signIn}</Text>
            </TouchableOpacity>
          </View>

          <View style={styles.regularTxt}>
            <Text style={styles.regularStyle}>{login4.account}</Text>

            <TouchableOpacity
              onPress={() => console.log('SignUp')}
              hitSlop={{top: 10, bottom: 10, right: 10, left: 10}}>
              <Text style={styles.signUpTxt}>{login4.signup}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAwareScrollView>
